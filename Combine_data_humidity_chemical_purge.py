...
filename_data='data_chemical_purge.xlsx'
...
for averaging in range(average_points):
    ...
    stds.append(data_logger["std RH, %"].sum())
    stdmax.append(data_logger["std RH, %"].max())
    stdmin.append(data_logger["std RH, %"].min())
    stdmean.append(data_logger["std RH, %"].mean())
