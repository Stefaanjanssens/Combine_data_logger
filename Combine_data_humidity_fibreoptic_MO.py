...
filename_data='FBGmicron - later-clean.xlsx'
...
plt.errorbar(x=data_logger["datetime"], y=data_logger["mean A1"],xerr=average_time ,yerr=data_logger["std pof1"], color="DarkGreen", label="DUT",fmt=".");
