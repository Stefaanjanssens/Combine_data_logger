...
filename_data='H96140252TrescalMI70c.xlsx'
...
additional_shift=timedelta( minutes=57)
...
ax=data_logger.plot.scatter(x='datetime', y='m%rh @PcTc 2500', color="DarkBlue", label="logger");
...
data_DUT.plot.line(x='datetime', y='RH', color="DarkBlue", label="DUT" ,ax=ax);

# az=data_logger.plot.scatter(x='datetime', y="mRHw_at_473", color="DarkRed", label="logger");
# plt.errorbar(x=data_logger["datetime"], y=data_logger["mean Temperature"],xerr=average_time ,yerr=data_logger["std RH"], color="DarkGreen", label="DUT",fmt=".");
