...
filename_data='H96140246 part2.xlsx'
...
plt.errorbar(x=data_logger["datetime"], y=data_logger["mean photo7 Last (C)"],xerr=average_time ,yerr=data_logger["std photo7 Last (C)"], color="DarkGreen", label="DUT",fmt=".");
data_DUT.plot.line(x='datetime', y='photo7 Last (C)', color="DarkBlue", label="DUT" ,ax=ax);
